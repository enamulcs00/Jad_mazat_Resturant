...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
  ...
  function srcAppLoginLoginComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "form.user .btn-user {\n  padding: 0.75rem 4rem !important;\n  margin: auto !important;\n}\n\n.btn-block {\n  width: auto !important;\n}\n\na {\n  cursor: pointer;\n}\n\n/* You can add global styles to this file, and also import other style files */\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LoginComponent = /*#__PURE__*/function () {
      function LoginComponent(api, localStorage, router, toastr, dialogService) {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function login() {
          ...
          this.api.singIn(this.loginBody).subscribe(function (response) {
            if (response["response"]["success"]) {
              if (response["data"]) {
                localStorage.setItem("id", response["data"]._id);
                localStorage.setItem("token", JSON.stringify(response["data"].authToken));
                localStorage.setItem("restaurantLogin", JSON.stringify(response["data"]));
              ...
              _this.toastr.errorToastr(response["response"]["message"]);
        ...
        value: function onForgotPassword() {
          ...
          this.dialogService.forgotPasswordsendEmail().subscribe(function (res) {
            console.log(res);
            ...
            if (res != undefined) {
              if (res["response"] == "yes" && res["email"] != "" && res["email"] != undefined) {
                ...
                _this2.api.forgotPasswordSendEmail(data).subscribe(function (response) {
                  if (response["response"]["success"]) {
                    _this2.toastr.successToastr("Reset password link sent successfully");
                  } else {
                    _this2.toastr.errorToastr('This email not registered with any account');
                  }
                });
              }
            }
